...
namespace UE4
{
	...
	namespace SDK
	{
		...
		//	//auto ViewInfo = driver.readv<FMinimalViewInfo>(PlayerCameraManager + 0x1fe0 + 0x10);
		//	
		//	CameraLocation = driver.readv<FVector>(PlayerCameraManager + 0x1260);
		//	CameraRotation = driver.readv<FVector>(PlayerCameraManager + 0x126C);
		//	float camera_fov = driver.readv<float>(PlayerCameraManager + 0x1278);
